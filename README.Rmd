...
!!!! **This repository has been archived.** Please see [clustifyrdatahub](https://github.com/rnabioco/clustifyrdatahub). !!!!
...
clustifyrdata provides `r length(tools::list_files_with_type("data", type = "data"))` external data sets for cell-type assignment with [clustifyr](https://rnabioco.github.io/clustifyr/) and [reproducible scripts](https://github.com/rnabioco/clustifyrdata/tree/main/data-raw) to build data objects.
