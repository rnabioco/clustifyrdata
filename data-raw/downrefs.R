...
d1 <- c(
    paste0("[", "ref_MCA", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_MCA.rda", ")"),
    "Mouse Cell Atlas",
...
d2 <- c(
    paste0("[", "ref_tabula_muris_drop", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_tabula_muris_drop.rda", ")"),
    "Tabula Muris (10X)",
...
d3 <- c(
    paste0("[", "ref_tabula_muris_facs", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_tabula_muris_facs.rda", ")"),
...
d4 <- c(
    paste0("[", "ref_mouse.rnaseq", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_mouse.rnaseq.rda", ")"),
...
d5 <- c(
    paste0("[", "ref_moca_main", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_moca_main.rda", ")"),
...
d6 <- c(
    paste0("[", "ref_immgen", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_immgen.rda", ")"),
    "Mouse sorted immune cells",
    dim(clustifyrdata::ref_immgen)[2],
    dim(clustifyrdata::ref_immgen)[1],
    "mouse",
    paste0("[from](", "https://www.nature.com/articles/ni1008-1091", ")")
)

d7 <- c(
    paste0("[", "ref_hema_microarray", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_hema_microarray.rda", ")"),
...
d8 <- c(
    paste0("[", "ref_cortex_dev", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_cortex_dev.rda", ")"),
...
d9 <- c(
    paste0("[", "ref_pan_indrop", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_pan_indrop.rda", ")"),
...
d10 <- c(
    paste0("[", "ref_pan_smartseq2", "](", "https://github.com/rnabioco/clustifyrdata/raw/main/data/ref_pan_smartseq2.rda", ")"),
...
d <- data.frame(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10) %>% t()
colnames(d) <- c("name", "desc", "ntypes", "ngenes", "org", "from_pub")
downrefs <- as_tibble(d) 
